...
import { User, Plus, Edit, Trash2, X, Save, Inbox } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 font-medium mt-1">
            <span className="text-[#ED1C24] font-bold">{utilisateurs.length}</span> ingénieur(s) enregistré(s)
          </p>
        </div>
        <button
        ...
        >
          <Plus size={18} /> Ajouter un ingénieur
        </button>
      </div>
      ...
      {utilisateurs.length === 0 ? (
        ...
        >
          ...
          <h3 className="text-xl font-black text-gray-800 uppercase italic mb-2">Aucun ingénieur enregistré</h3>
          <p className="text-gray-400 font-medium">Cliquez sur "Ajouter un ingénieur" pour commencer.</p>
        </motion.div>
      ) : (
